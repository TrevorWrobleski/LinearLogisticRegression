...
- **[🏍️ Motorcycle Specs 2020](moto_data/moto_README.md)** — 656 motorcycles from 15 major brands with engine specs, dimensions, and a custom binary outcome (`trevors_fav`) for logistic regression. Hopefully you find this helpful for both linear and logistic regression.